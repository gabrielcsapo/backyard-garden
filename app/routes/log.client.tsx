                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {entry.type === 'stage_change' && entry.stage && (
                      <p className="text-sm text-garden-700 mt-1">
                        Stage: {entry.stage}
                      </p>
                    )}
                  </div>
...
export function QuickLogForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (selectedPlanting)
      fd.set('yardElementId', String(selectedPlanting.yardElementId))
    if (defaultYardElementId)
      fd.set('yardElementId', String(defaultYardElementId))
