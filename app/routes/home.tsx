...
const Component = async () => {
  ...
  const EVENT_ICONS: Record<string, string> = {
    ...
    pruning: 'M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z',
          ...
          <div className="flex flex-wrap items-center gap-3 mb-6">
            ...
            {userSettings.lastFrostDate && (
              <div className="inline-flex items-center gap-1.5 text-gray-500 text-sm">
                Last frost:{' '}
                {new Date(userSettings.lastFrostDate).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}
              </div>
            )}
          </div>
              ...
              {firstYard ? (
                ...
                >
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Set up your yard and start planning.
                  </p>
                </Link>
              )}
