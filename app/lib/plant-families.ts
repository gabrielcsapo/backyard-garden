export const PLANT_FAMILIES: Record<string, { label: string; color: string; plants: string[] }> = {
  ...
  cucurbitaceae: {
    ...
    plants: ['Cucumber', 'Zucchini', 'Summer Squash', 'Winter Squash', 'Pumpkin', 'Watermelon', 'Cantaloupe', 'Honeydew'],
  },
  brassicaceae: {
    label: 'Brassicas',
    color: 'bg-teal-100 text-teal-700',
    plants: ['Broccoli', 'Cauliflower', 'Cabbage', 'Brussels Sprouts', 'Kohlrabi', 'Kale', 'Collard Greens', 'Bok Choy', 'Turnip', 'Radish', 'Rutabaga', 'Daikon Radish', 'Arugula', 'Mustard Greens', 'Watercress', 'Mizuna'],
  },
  fabaceae: {
    label: 'Legumes',
  ...
  asteraceae: {
    ...
    plants: ['Lettuce', 'Romaine Lettuce', 'Endive', 'Radicchio', 'Artichoke', 'Tarragon', 'Chamomile', 'Marigold', 'Sunflower'],
  },
  amaranthaceae: {
    label: 'Chenopods',
